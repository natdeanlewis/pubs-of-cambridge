...
export default function Markers({ map, markers, pubs, visitedPubs, creditsMusic, setComplete, setNearestPub, setRandomPub, setVisitedPubs, firstTime, playSound, INITIAL_MAP_SETTINGS }) {
    useEffect(() => {
        if (!map) return;
